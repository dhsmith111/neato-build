...
// Relay board: 50.5mm long x 38.5mm wide (walls on long 50.5mm axis).
// Walls on X axis (long board dimension): pod_width = 38.5 + 3 + 3 + 5 + 5 = 55mm
// Open on Y axis (long board dimension): pod_depth = 50.5 + 3 + 3 = 57mm
pod_width  = 55;
pod_depth  = 57;
pod_height = 66;
...
relay_hole_x_span = 33.5;  // short span — runs along X between walls
relay_hole_y_span = 45.0;  // long span — runs along Y open direction
